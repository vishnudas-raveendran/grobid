...
The latest stable release of GROBID is version ```0.5.1```. As compared to previous version ```0.4.4```, this version brings:
...
+ (thanks to @detonator413 and @lfoppiano for this release! future work in versions will focus again on improving PDF parsing and structuring accuracy)
